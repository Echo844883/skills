var pdfjsLib = (() => {
  ...
  __export(pdf_min_exports, {
    ...
    AnnotationEditorType: () => Vt,
    AnnotationEditorUIManager: () => jt,
    AnnotationLayer: () => Wt,
    AnnotationMode: () => qt,
    ColorPicker: () => Xt,
    DOMSVGFactory: () => Kt,
    ...
    OPS: () => ie,
    OutputScale: () => se,
    PDFDataRangeTransport: () => ne,
    PDFDateString: () => ae,
    PDFWorker: () => re,
    PasswordResponses: () => oe,
    PermissionFlag: () => le,
    PixelsPerInch: () => he,
    RenderingCancelledException: () => de,
    TextLayer: () => ce,
    TouchManager: () => ue,
    UnexpectedResponseException: () => pe,
    Util: () => ge,
    VerbosityLevel: () => me,
    XfaLayer: () => fe,
    build: () => be,
    createValidAbsoluteUrl: () => Ae,
    fetchData: () => we,
    getDocument: () => ve,
    getFilenameFromUrl: () => ye,
    getPdfFilenameFromUrl: () => xe,
    getXfaPageViewport: () => _e,
    isDataScheme: () => Ee,
    isPdfFile: () => Se,
    noContextMenu: () => Ce,
    normalizeUnicode: () => Te,
    setLayerDimensions: () => Me,
    shadow: () => Pe,
    stopEvent: () => De,
    version: () => ke
  });
